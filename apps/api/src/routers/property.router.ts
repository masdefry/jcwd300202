import { createProperty, dataForFilteringProperty, getProperties, getPropertyDetail, getPropertyRoomTypeByProperty, getRoomType } from "@/controllers/property.controller";
