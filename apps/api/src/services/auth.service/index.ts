...
export const verifyEmailRequestUserService = async ({
  email,
}: Pick<IUser, 'email'>) => {
  const isUserExist = await prisma.user.findUnique({
    where: {
...
export const verifyChangeEmailRequestUserService = async ({
  id,
  role,
}: Pick<IUser, 'id' | 'role'>) => {
  const isUserExist = await prisma.user.findUnique({
...
export const verifyChangeEmailRequestTenantService = async ({
  id,
  role,
}: Pick<IUser, 'id' | 'role'>) => {
  const isTenantExist = await prisma.tenant.findUnique({
...
export const verifyEmailRequestTenantService = async ({
  email,
}: Pick<IUser, 'email'>) => {
  const isTenantExist = await prisma.tenant.findUnique({
    where: {
...
export const verifyEmailTenantService = async ({
  id,
  token,
  password,
}: Pick<IUser, 'id' | 'token' | 'password'>) => {
...
export const sendEmailResetPasswordUserService = async ({
  email,
}: Pick<IUser, 'email'>) => {
  const isUserExist = await prisma.user.findUnique({
    where: {
...
export const sendEmailResetPasswordTenantService = async ({
  email,
}: Pick<IUser, 'email'>) => {
  const isTenantExist = await prisma.tenant.findUnique({
    where: {
...
export const keepAuthService = async ({
  id,
  role,
  token,
}: Pick<IUser, 'role' | 'token' | 'id'>) => {
  let isAccountExist,
    username,
    profilePictureUrl,
    isVerified,
...
export const verifyChangeEmailTenantService = async ({
  id,
  role,
  token,
}: Pick<IUser, 'role' | 'token' | 'id'>) => {
...
export const verifyChangeEmailUserService = async ({
  id,
  role,
  token,
}: Pick<IUser, 'role' | 'token' | 'id'>) => {
