...
export const getPropertyFacilityService = async ({name}: { name: string }) => {
...
export const createPropertyFacilityService = async ({ id, role, name, imagesUploaded }: Pick<IUser, 'id' | 'role'> & { imagesUploaded: any, name: string } ) => {
