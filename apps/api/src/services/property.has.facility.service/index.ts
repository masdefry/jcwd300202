...
export const getPropertyHasFacilitiesService = async ({id, role, slug, name} : Pick<IUser, 'id' | 'role'> & Pick<IProperty, 'slug' | 'name'>) => {
...
export const updatePropertyHasFacilitiesService = async ({ propertyFacilitiesId, id, role, slug }: Pick<IUser, 'id' | 'role'> & Pick<IProperty, 'slug'> & { propertyFacilitiesId: any} ) => {
