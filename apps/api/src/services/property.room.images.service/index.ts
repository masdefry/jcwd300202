...
export const getPropertyRoomImagesByPropertyService = async ({roomId}: { roomId: string | number }) => {
...
export const createPropertyRoomImagesByPropertyService = async ({id, role, roomId, imagesUploaded}: Pick<IUser, 'id' | 'role'> & { imagesUploaded: any, roomId: string | number }) => {
...
export const deletePropertyRoomImagesByPropertyService = async ({ id, role, propertyRoomImageId}: Pick<IUser, 'id' | 'role'> & { propertyRoomImageId: string | number }) => {
