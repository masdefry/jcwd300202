...
export const createPropertyService = async ({
    ...
    propertyRoomTypes,
    imagesUploaded
  }: Partial<IProperty> & Partial<IPropertyDetail> & { name: string, role: string, countPropertyImages: number | string, propertyFacilitiesId: any, propertyRoomTypes: any, imagesUploaded: any }) => {
...
export const getPropertyDetailService = async ({checkInDate, checkOutDate, adult, children, slug}: Pick<IProperty, 'slug'> & Pick<ITransaction, 'adult' | 'children'> & { checkInDate: string, checkOutDate: string }) => {
...
export const getPropertyRoomTypeByPropertyService = async ({propertyId, limit, offset}: {propertyId: string, limit: string | number, offset: string | number}) => {
...
export const getPropertiesByUserService = async ({ id, role }: Pick<IUser, 'id' | 'role'>) => {
...
export const deletePropertyService = async({ id, role, password, slug }: Pick<IProperty, 'slug'> & Pick<IUser, 'id' | 'role' | 'password'>) => {
