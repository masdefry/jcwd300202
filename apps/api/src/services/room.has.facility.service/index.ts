...
export const getRoomHasFacilitiesService = async({ id, role, propertyRoomTypeId, name  } : Pick<IUser, 'id' | 'role'> & Pick<IRoomHasFacilities, 'propertyRoomTypeId'> & Pick<IPropertyRoomFacility, 'name'>) => {
...
export const getGeneralRoomHasFacilitiesByPropertyService = async({ id, role, slug, name }: Pick<IUser, 'id' | 'role'> & Pick<IPropertyRoomFacility, 'name'> & Pick<IProperty, 'slug'>) => {
...
export const updateRoomHasFacilitiesService = async({ propertyRoomFacilitiesId, id, role, propertyRoomTypeId }: Pick<IUser, 'id' | 'role'> & Pick<IRoomHasFacilities, 'propertyRoomTypeId'> & { propertyRoomFacilitiesId: any}) => {
...
export const updateRoomHasFacilitiesByPropertyService = async({ propertyRoomFacilitiesId, id, role, slug }: Pick<IUser, 'id' | 'role'> & Pick<IProperty, 'slug'> & { propertyRoomFacilitiesId: any }) => {
