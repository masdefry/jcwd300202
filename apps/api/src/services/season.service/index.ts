...
export const createSeasonalPriceService = async ({
    ...
    endDate,
    isPeak,
  }: Pick<IUser, 'id' | 'role'> & Pick<ISeasonalPrice, 'isPeak' | 'propertyRoomTypeId'> & Pick<ISeason, 'name' | 'availability'> & { startDate: string, endDate: string,  roomPrices: number | string, roomsToSell: number | string  }) => {
...
export const getBulkSeasonalPriceAndAvailabilityService = async ({ id, role, startDate, endDate, propertyRoomTypeId }: Pick<IUser, 'id' | 'role'> & Pick<ISeasonalPrice,'propertyRoomTypeId'> & { startDate: string, endDate: string }) => {
...
export const getSingleSeasonalPriceAndAvailabilityService = async ({ propertyRoomTypeId, date }: Pick<ISeasonalPrice, 'propertyRoomTypeId'> & { date: string }) => {
...
export const updateSeasonalPriceService = async ({
    ...
    isPeak,
    propertyRoomTypeId
  }: Pick<IUser, 'id' | 'role'> & Pick<ISeasonalPrice, 'isPeak' | 'propertyRoomTypeId'> & Pick<ISeason, 'name' | 'availability'> & { startDate: string, endDate: string,  roomPrices: number | string, roomsToSell: number | string  } & Pick<ISeasonalPrice, 'seasonId'> & { seasonalPriceId: number | string }) => {
...
export const getSeasonsByPropertyService = async ({ id, role, month, slug, year }: Pick<IUser, 'id' | 'role'> & Pick<IProperty, 'slug'> & {month: string | number, year: string | number}) => {
...
export const createSeasonalAvailabiltyByPropertyService = async ({
    ...
    isPeak,
    slug
  }: Pick<ISeason, 'availability' | 'name' | 'isPeak'> & Pick<IUser, 'id' | 'role'> & Pick<IProperty, 'slug'> & { pricePercentage: string | number, startDate: string, endDate: string} ) => {
...
export const updateManySeasonsByPropertySeasonService = async ({
      ...
      isPeak,
      slug
    }: Pick<IProperty, 'slug'> & Pick<ISeasonalPrice, 'isPeak' | 'seasonId'> & Pick<ISeason, 'name' | 'availability'> & Pick<IUser, 'id' | 'role'> & { startDate: string, endDate: string, pricePercentage: string | number }) => {
...
export const deletePropertySeasonService = async ({ id, role, slug, seasonId }: Pick<IUser, 'id' | 'role'> & Pick<IProperty, 'slug'> & Pick<ISeasonalPrice, 'seasonId'>) => {
...
export const deleteSeasonalPriceService = async ({ id, role, propertyRoomTypeId, seasonalPriceId }: Pick<IUser, 'id' | 'role'> & Pick<ISeason, 'propertyRoomTypeId'> & {seasonalPriceId: number}) => {
...
export const getSeasonsByPropertyRoomTypeService = async ({ id, role, month, propertyRoomTypeId, year }: Pick<IUser, 'id' | 'role'> & Pick<ISeason, 'propertyRoomTypeId'> & {month: number, year: number}) => {
...
export const updateSingleSeasonService = async ({
    ...
    isPeak,
    seasonId
  }: Pick<IUser, 'id' | 'role'> & Pick<ISeason, 'propertyRoomTypeId'| 'name'| 'availability' | 'isPeak'> & Pick<ISeasonalPrice, 'seasonId'> & {startDate: string, endDate: string, roomPrices: number, roomsToSell: number, pricePercentage: number}) => {
...
export const createOneSeasonService = async ({
    ...
    endDate,
    isPeak,
  }: Pick<IUser, 'id' | 'role'> & Pick<ISeason, 'propertyRoomTypeId'| 'name'| 'availability' | 'isPeak'> & {startDate: string, endDate: string, roomPrices: number, roomsToSell: number, pricePercentage: number}) => {
...
export const deleteSingleSeasonService = async({id, role, seasonId, propertyRoomTypeId}: Pick<IUser, 'id' | 'role'> & Pick<ISeason, 'propertyRoomTypeId'> & Pick<ISeasonalPrice, 'seasonId'>) => {
...
export const getSingleSeasonService = async ({ id, role, seasonId }: Pick<IUser, 'id' | 'role'> & Pick<ISeasonalPrice, 'seasonId'>) => {
