...
export const getUserProfileService = async ({ id, role }: Pick<IUser, 'id' | 'role'>) => {
...
export const updateUserProfileService = async ({
    ...
    year,
    address,
  }: Pick<IUser, 'id' | 'role' | 'email' | 'username' | 'phoneNumber' | 'address' | 'gender'> & { date: number, month: number, year: number }) => {
...
export const updateUserProfilePictureService = async ({ id, role, imagesUploaded }: Pick<IUser, 'id' | 'role'> & { imagesUploaded: any }) => {
...
export const updateUserEmailService = async ({ id, role, email }: Pick<IUser, 'id' | 'role' | 'email'>) => {
...
export const deleteUserProfileService = async ({ id, role }: Pick<IUser, 'id' | 'role'>) => {
