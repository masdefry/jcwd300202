        ...
        <div className="2xl:col-span-3 w-full min-h-min flex flex-col gap-3 px-3">
            ...
            <span className="flex items-center gap-5 col-span-2">
              ...
              <span className="w-2/3 flex gap-2 items-center">
                ...
                <select
                  ...
                  defaultValue={`${searchParams?.order || 'asc'}-${searchParams['sort-by'] || 'price'}`}
                  id="sort"
          ...
          {dataProperties?.properties.map((item: any, index: number) => {
            return (
              <div
                key={index}
                className="bg-white w-full h-fit 2xl:h-[15rem] rounded-lg flex 2xl:flex-row flex-col items-start gap-3 shadow-md border border-slate-200"
              >
                  ...
                  <div className="flex justify-between">
                    <hgroup className="flex flex-col w-full">
                      ...
                      <div className="2xl:hidden flex flex-col gap-1 items-start">
                        ...
                        <p className="text-xs font-bold rounded-full text-green-800 bg-green-200 p-1">
                          Awesome
                        </p>
                      </div>
