...
import AccomodationRecommendation from '../../../../features/property/details/components/AccomodationRecommendation'
    ...
    <main className="w-full min-h-min 2xl:py-5 pb-5">
      <section className="m-auto max-w-screen-xl flex flex-col gap-7">
        ...
        {dataPropertyDetail?.propertyListByCity.length > 0 && (
          <AccomodationRecommendation dataPropertyDetail={dataPropertyDetail} />
        )}
