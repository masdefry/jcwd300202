...
const FilterAndSortPropertyType = ({isPending, handleFilter, handleSort, searchParams, handleCreatePropertyType}: {handleCreatePropertyType: any, searchParams: ISearchParamsTenantPropertyType, handleFilter: (name: string) => void, handleSort: (order: string) => void, isPending: boolean}) => {
  const [ search, setSearch ] = useState('')  
  const [ showCreatePropertyType, setShowCreatePropertyType ] = useState<boolean>(false)
  ...
  if(isPending) {
    return (
      <section className="flex justify-between items-center gap-2 w-[1080px]">
    ...
    <section className="flex justify-between items-center gap-2 w-[1080px]">
      ...
      </button>
      {
        showCreatePropertyType && (
            <CreatePropertyType setShowCreatePropertyType={setShowCreatePropertyType} handleCreatePropertyType={handleCreatePropertyType}/>
        )
      }
