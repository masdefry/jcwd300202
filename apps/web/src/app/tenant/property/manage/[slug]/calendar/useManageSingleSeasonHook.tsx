...
import useMutateGetSingleSeasonHook from './useMutateGetSingleSeasonHook'
import useMutateCreateSingleSeasonHook from './useMutateCreateSingleSeasonHook'
import toast from 'react-hot-toast'
import useMutateUpdateSingleSeasonHook from './useMutateUpdateSingleSeasonHook'
import useMutateDeleteSingleSeasonHook from './useMutateDeleteSingleSeasonHook'
...
const useManageSingleSeasonHook = ({
  ...
  selectedPropertyRoomType
    ...
    activeRoomSetter: IActiveRoomSetter,
      ...
      useMutateCreateSingleSeasonHook({
        dataPropertyRoomTypeSeason, onSuccess, onError, selectRoom, dateRange, activeRoomSetter
      })  
    
      const {
        mutateUpdateSingleSeason,
        isPendingUpdateSingleSeason,
      } = useMutateUpdateSingleSeasonHook({ dataPropertyRoomTypeSeason, onSuccess, onError, selectRoom, dateRange, activeRoomSetter, })
    
      const {
        mutateDeleteSingleSeason,
        isPendingDeleteSingleSeason,
      } = useMutateDeleteSingleSeasonHook({ dataPropertyRoomTypeSeason, onSuccess, onError, selectedPropertyRoomType })
