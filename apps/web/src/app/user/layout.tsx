            ...
            <section className=" max-w-screen-xl px-5 m-auto hidden lg:flex justify-between items-center w-full h-full">
              ...
              <nav className="text-base font-medium py-5 text-slate-900">
                <ul className="flex gap-8 items-center">
                  {token && (
                    <li
                      className="text-red-700 hover:opacity-75 hover:cursor-pointer active:scale-90 transition duration-100 flex items-center gap-1.5 text-sm font-bold"
                  ...
                  {token ? (
                    ...
                    <Link href="/auth">
                      <li className="text-sm font-bold rounded-full bg-white text-gray-800 px-7 py-3 hover:opacity-75 hover:cursor-pointer active:scale-90 transition duration-200">
