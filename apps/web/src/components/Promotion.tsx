...
const Promotion = () => {
  return (
    <section className='p-4 sm:px-8 md:px-12 lg:px-16 justify-center flex flex-col gap-5 h-[190px] md:h-[230px] w-full overflow-hidden relative'>
        ...
        <div className='flex flex-col m-auto max-w-screen-xl w-full'>
          ...
          <button className="text-white active:scale-90 z-20 rounded-md transition duration-200 md:text-base text-sm mt-3 px-5 md:px-9 py-3 md:py-5 border border-white hover:bg-white hover:text-black w-fit">Book now</button>
        </div>
    </section>
  )
}
