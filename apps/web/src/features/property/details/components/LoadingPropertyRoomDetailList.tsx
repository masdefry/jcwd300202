        ...
        Array.from({length: 2}).map((item: any, index: number) => {
            ...
            <section key={index} className='w-full grid grid-cols-3 gap-5 2xl:gap-10 items-center rounded-md bg-white shadow-md p-3'>
                <div className='w-full rounded-md flex flex-col gap-2 2xl:col-span-1 col-span-3'>
                    <h1 className='text-base sm:text-lg text-transparent bg-slate-300 rounded-none font-bold w-fit'>Penthouse Oceanview</h1>
                    ...
                    <div className='ml-5 text-left text-transparent w-fit bg-slate-300 rounded-none text-xs md:text-sm font-bold  '>Room details</div>
                </div>
                <div className='2xl:col-span-2 col-span-3'>
                    ...
                    <table className="table min-w-max">
                            ...
                            <tr className='text-base font-bold text-transparent'>
                                <th><p className='text-transparent bg-slate-300 rounded-none w-fit'> Room Choice</p></th>
                                <th><p className='text-transparent bg-slate-300 rounded-none w-fit'>Guest</p></th>
                                <th><p className='text-transparent bg-slate-300 rounded-none w-fit'>Price/Room</p></th>
                            ...
                            <tr>
                                <td className='flex flex-col gap-2 w-[300px]'>
                                    <p className='sm:flex hidden text-sm font-light  text-transparent bg-slate-300 rounded-none w-fit'>Deluxe Room</p>
                                    <p className='lg:text-base text-sm font-semibold  text-transparent bg-slate-300 rounded-none w-fit'>With breakfast for 2 people</p>
                                            ...
                                            Array.from({length: 4}).map((itm: any, idx: number) => {
                                                return(
                                                    <div key={idx} className='flex sm:text-sm font-medium text-transparent text-xs tracking-wide items-center gap-2'>
                                                        <figure className='h-4 w-4 rounded-full bg-slate-300 '>
                                                        </figure>
                                                        <p className='  bg-slate-300 rounded-none w-fit'>My Room</p>
                                                    </div>
                                                )
                                            })
                                        }
                                    ...
                                    <div className='mx-auto flex flex-wrap gap-2 items-center w-[100px] justify-center'>
                                        {
                                            Array.from({length:2}).map((item, index) => {
                                                return(
                                                  <figure key={index} className='h-5 w-5 rounded-full bg-slate-300 '>
                                                        </figure>
                                                )
                                            })
                                        }
                                ...
                                <td className='text-right'>
                                    <p className='text-lg mb-1 font-bold text-transparent  rounded-none w-fit bg-slate-300'>Rp5000000</p>
                                    <p className='text-xs font-semibold text-transparent  rounded-none w-fit bg-slate-300'>Include taxes and price</p>
                                </td>
                                <td className='w-[200px]'>
                                  <div className=' my-auto italic text-sm font-bold min-w-max px-8 py-3 rounded-full bg-gray-200 text-transparent  ' >Book Now</div>
