...
export const updateTenantProfileValidationSchema = Yup.object().shape({
    ...
    pic: Yup.string().matches(/^[a-zA-Z0-9\s]*$/, 'No special characters allowed!').nullable(),
    companyName: Yup.string().matches(/^[a-zA-Z0-9\s]*$/, 'No special characters allowed!').nullable(),
