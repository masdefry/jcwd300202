...
const TextInput = ({ labelName, name, placeholder, type }: ITextInputProps) => {
  return (
    <div className="grid items-center gap-1.5 w-full relative">
        ...
        <Field name={name} type={type} id={name} placeholder={placeholder} className="w-full py-1.5 border-b-2 border-slate-300 text-sm placeholder-shown:text-sm rounded-none focus:outline-none focus:border-blue-600"/>
