      ...
      <div className="flex flex-col gap-4 justify-center">
        <table className="table table-xs min-w-[1080px]">
          ...
          <tbody>
            ...
            dataProperties?.properties?.length > 0 ? (
              ...
              <tr>
                <td
                  colSpan={8}
                  className="text-center text-slate-300 font-bold p-3"
                >{`Oops! We Couldn't Find the Property You're Looking For`}</td>
              </tr>
            )}
          </tbody>
        </table>
