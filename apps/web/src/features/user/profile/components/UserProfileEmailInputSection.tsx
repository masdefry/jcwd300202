...
import { IUseManageUserProfileHook } from '../types'

const UserProfileEmailInputSection = ({
  newEmail,
  setFieldValue,
  mutateUpdateEmail,
  setNewEmail,
    ...
    <div className="flex items-end gap-3">
      <div className="flex flex-col gap-1 w-full">
        ...
        <button
          ...
          className="disabled:bg-slate-300 disabled:text-white disabled:scale-100 disabled:opacity-100 2xl:hidden w-full flex justify-center  px-5 py-2 font-bold hover:opacity-70 active:scale-90 transition duration-100 text-sm bg-gray-900 text-white border border-gray-900 rounded-full"
        >
          Change
        </button>
      </div>
      <button
        ...
        className="disabled:bg-slate-300 disabled:text-white disabled:scale-100 disabled:opacity-100 2xl:flex hidden mb-5 px-5 py-2 font-bold hover:opacity-70 active:scale-90 transition duration-100 text-sm bg-gray-900 text-white w-fit border border-gray-900 rounded-full"
      >
        Change
      </button>
      {showChangeEmail && (
...
export default UserProfileEmailInputSection
