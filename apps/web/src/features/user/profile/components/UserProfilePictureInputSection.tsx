...
const UserProfilePictureInputSection = ({
  imagePreview,
  dataUserProfile,
  setFieldValue,
  setImagePreview,
  ...
  'imagePreview' | 'dataUserProfile' | 'setImagePreview'
        ...
        <figure className="overflow-hidden rounded-full h-[150px] w-[150px] bg-slate-200 border-2 border-slate-300">
          <Image
            src={
              ...
              (dataUserProfile?.profilePictureUrl as string)
            }
            width={500}
            height={500}
            alt=""
...
export default UserProfilePictureInputSection
